  ...
  const [modalVisible, setModalVisible] = useState(false);
    return (
        ...
        <View>
          ...
          <Text style={styles.title} numberOfLines={5}>Frontend</Text>
          <View>
            <Text style={styles.text}>Ngân sách: 1000$</Text>
            <Text style={styles.text}>Ngày nộp: 20/07/2024</Text>
            <Text style={styles.text}>Số proposal gửi: 20</Text>
          </View>
        </View>
        <View style={styles.containerButton}>
          ...
          <TouchableOpacity>
            <Button mode="contained" style={{ margin: 5, backgroundColor:"red"}}>
              Hủy ứng tuyển
            </Button>
          </TouchableOpacity>
        </View>
